  ...
  aboutPrinciples: {
    header: {
      ...
      description: [
        [
          {
            text: "Good heating work is not only about installing equipment. It is about understanding the property, giving honest advice and completing every detail responsibly.",
          },
        ],
      ],
    },
  ...
  services: {
    header: {
      ...
      description: [
        [
          {
            text: "From routine servicing to complete installations, our local engineers help keep your home warm across Hatfield, Hertfordshire and London.",
          },
        ],
      ],
    },
