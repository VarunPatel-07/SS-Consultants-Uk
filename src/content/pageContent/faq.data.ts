...
export const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      "Yes. Every engineer at SS Consultants is Gas Safe registered, so all servicing, repairs and installations are carried out safely and in line with current regulations.",
  },
  {
    question: "Which areas do you cover?",
    answer: "We cover Hatfield and the surrounding Hertfordshire area, as well as London.",
  },
  {
    question: "How much does a new boiler installation cost?",
    answer:
      "Costs vary depending on your home, the boiler you choose and the complexity of the job. Get in touch for a free, no-obligation quote tailored to your property.",
  },
  {
    question: "How long does a boiler installation take?",
    answer:
      "Most straightforward installations are completed within a day, though larger jobs may take longer. We'll give you a clear timescale before work begins.",
  },
  {
    question: "Do your installations include a guarantee?",
    answer: "Yes, every installation comes with a 24-month guarantee for your peace of mind.",
  },
  {
    question: "Can you repair and service my existing boiler?",
    answer: "Yes, we service and repair boilers from all major manufacturers, not just the brands we install.",
  },
];
...
export const BOILER_SERVICE_FAQ_DATA = [
  {
    question: "Are your engineers Gas Safe registered?",
    answer:
      "Yes. Every engineer at SS Consultants is Gas Safe registered, so all servicing and repairs are carried out safely and in line with current regulations.",
  },
  {
    question: "How often should I service my boiler?",
    answer:
      "Most manufacturers recommend an annual service to keep your warranty valid and your boiler running safely and efficiently.",
  },
  {
    question: "What's the difference between Essential Inspection and Full Maintenance?",
    answer:
      "Essential Inspection (£80 + VAT) covers a full visual and safety check, combustion analysis and filter clean. Full Maintenance (£120 + VAT) includes everything in the Essential Inspection plus a deeper clean of the burner chamber and heat exchanger.",
  },
  {
    question: "Do you service all boiler brands?",
    answer:
      "Yes, we service and repair boilers from all major manufacturers, including Vaillant, Worcester Bosch, Baxi, Ideal and Main.",
  },
  {
    question: "Can you provide a landlord gas safety certificate",
    answer: "Yes, we carry out landlord gas safety checks (CP12) and provide the certificate on completion.",
  },
  {
    question: "What areas do you cover?",
    answer: "Hatfield, Hertfordshire and London.",
  },
];
...
export const BOILER_BREAKDOWN_REPAIRS_FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "If a repair isn't cost-effective, we'll give you honest advice on your replacement options instead.",
  },
  {
    question: "Do repairs come with a guarantee?",
    answer: "Yes, repair work is guaranteed. We'll confirm the applicable guarantee period before work begins.",
  },
];
...
export const UNDERFLOOR_HEATING_FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "Yes, we specialise in Heatmiser systems specifically, covering both installation and fault-finding.",
  },
  {
    question: "Will you need to lift my flooring?",
    answer: "In most cases, no. Our thermal imaging approach lets us identify the fault without disturbing your floor.",
  },
  {
    question: "What areas do you cover?",
    answer:
  ...
  },
  {
    ...
    answer: "Yes, all our work is covered by a 24-month warranty, and we carry £5m public liability insurance.",
  },
];
...
export const POWERFLUSHING_FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "Yes, we always add a fresh corrosion inhibitor as standard once the flush is complete.",
  },
];
